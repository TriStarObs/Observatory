'tabs=4
' --------------------------------------------------------------------------------
' ASCOM Dome driver for TriStar Observatory
'
' Description:	ASCOM driver which, while specific to TriStar Observatory, should
'               function reasonably well for most domes.
'
'               This driver presumes an Arduino (or similar) microprocessor 
'               controlled dome with 2 motors, one for shutter one for dome
'               rotation.
'
'               The driver sends serial commands interpreted by the microprocessor(s)
'               into motor commands.
'
' Implements:	ASCOM Dome interface version: 1.0
' Author:		EorEquis@tristarobservatory.space
'
' Edit Log:
'
' Date			Who	Vers	Description
' -----------	---	-----	-------------------------------------------------------
' 15-FEB-2017	eor	0.0.1	Initial edit, from Dome template
' ---------------------------------------------------------------------------------
'
'
...
<Guid("6b6950a7-681a-4dbf-ace6-7292a23c0c40")> _
...
Public Class Dome
    ...
    Public Sub New()
        ...
        'TODO: Implement additional construction here
...
#Region "Common properties and methods"
    ...
    Public ReadOnly Property Name As String Implements IDomeV2.Name
        Get
            Dim s_name As String = "TriStar Observatory Dome"
...
#Region "IDome Implementation"
    ...
    Public ReadOnly Property CanSlave() As Boolean Implements IDomeV2.CanSlave
        Get
            'TODO : Determine if this is necessayr for SGP slaving
    ...
    Public Sub Park() Implements IDomeV2.Park
        'TODO : Park code in Arduino.  p#?
        TL.LogMessage("Park", "Not implemented")
        Throw New ASCOM.MethodNotImplementedException("Park")
    End Sub

    Public Sub SetPark() Implements IDomeV2.SetPark
        'TODO : Find out what SetPark is since I appear to be implementing it
    ...
    Public ReadOnly Property ShutterStatus() As ShutterState Implements IDomeV2.ShutterStatus
        Get
            'I'm pretty sure this is wrong.  Should be ShutterStatus Get?
            TL.LogMessage("CanSyncAzimuth Get", False.ToString())
    ...
    Public Sub SlewToAzimuth(Azimuth As Double) Implements IDomeV2.SlewToAzimuth
        ' TODO : Implement azimuth handling in Arduino, implement this method
