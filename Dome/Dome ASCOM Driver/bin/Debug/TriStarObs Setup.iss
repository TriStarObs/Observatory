...
; Generated by EorEquis on 2/18/2017 (UTC)
;
[Setup]
AppID={{8583031e-5727-4795-88b1-7a3460c10ed2}
AppName=ASCOM TriStarObs Dome Driver
AppVerName=ASCOM TriStarObs Dome Driver 0.1.1
AppVersion=0.1.1
...
OutputDir="."
OutputBaseFilename="TriStarObs Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\TriStarObs"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\TriStarObs"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "D:\Development\TriStarObservatory\Observatory\Dome\Dome ASCOM Driver\bin\Debug\Dome ASCOM Driver.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "D:\Development\TriStarObservatory\Observatory\Dome\Dome ASCOM Driver\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\Dome ASCOM Driver.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\Dome ASCOM Driver.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\Dome ASCOM Driver.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\Dome ASCOM Driver.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\Dome ASCOM Driver.dll"""; Flags: runhidden 64bit; Check: IsWin64
